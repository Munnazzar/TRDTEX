...
\pagestyle{fancy}
\fancyhf{}
\lhead{\textbf{Paranoid Android} -- ICPC Reference}
\rhead{\thepage}
...
% ==========================================
\begin{titlepage}
    \pagestyle{empty} % Removes header/footer from cover page
    \centering
    \vspace*{3cm}     % Vertical padding from top

    % University / Organization Name
    {\Huge \textbf{NU-FAST KARACHI}} \\[0.5cm]
    {\Large \textit{Department of Computer Science}}

    \vspace{3.5cm}

    % Team Name with horizontal rules for emphasis
    \rule{\linewidth}{1mm} \\[0.4cm]
    {\fontsize{50}{60}\selectfont \textbf{Paranoid Android}} \\[0.2cm]
    \rule{\linewidth}{1mm}

    \vspace{1.5cm}

    % Document Type & Date
    {\LARGE \textbf{ICPC Team Reference Document}} \\[0.5cm]
    {\Large \today}
    ...
    \begin{center} \Large
        \textbf{Members:} \\ [0.5em]
        Munnazzar Shahzad \hspace{2cm} $\cdot$ \hspace{2cm} Asfandyar Khanzada \hspace{2cm} $\cdot$ \hspace{2cm} Asim Ali
    \end{center}
...
vi cover(vector<vi>& g, int n, int m) {
	vi match(m, -1);
	int res = dfsMatching(g, match); // hopcrafkt
